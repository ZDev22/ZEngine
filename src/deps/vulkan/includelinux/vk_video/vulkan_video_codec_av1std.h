...
typedef struct StdVideoAV1LoopFilter {
    ...
    unsigned char loop_filter_level[STD_VIDEO_AV1_MAX_LOOP_FILTER_STRENGTHS];
    unsigned char loop_filter_sharpness;
    unsigned char update_ref_delta;
    signed char loop_filter_ref_deltas[STD_VIDEO_AV1_TOTAL_REFS_PER_FRAME];
    unsigned char update_mode_delta;
    signed char loop_filter_mode_deltas[STD_VIDEO_AV1_LOOP_FILTER_ADJUSTMENTS];
...
typedef struct StdVideoAV1Segmentation {
    unsigned char FeatureEnabled[STD_VIDEO_AV1_MAX_SEGMENTS];
    short FeatureData[STD_VIDEO_AV1_MAX_SEGMENTS][STD_VIDEO_AV1_SEG_LVL_MAX];
...
typedef struct StdVideoAV1CDEF {
    ...
    unsigned char cdef_y_pri_strength[STD_VIDEO_AV1_MAX_CDEF_FILTER_STRENGTHS];
    unsigned char cdef_y_sec_strength[STD_VIDEO_AV1_MAX_CDEF_FILTER_STRENGTHS];
    unsigned char cdef_uv_pri_strength[STD_VIDEO_AV1_MAX_CDEF_FILTER_STRENGTHS];
    unsigned char cdef_uv_sec_strength[STD_VIDEO_AV1_MAX_CDEF_FILTER_STRENGTHS];
} StdVideoAV1CDEF;
typedef struct StdVideoAV1LoopRestoration {
    ...
    unsigned short LoopRestorationSize[STD_VIDEO_AV1_MAX_NUM_PLANES];
} StdVideoAV1LoopRestoration;
typedef struct StdVideoAV1GlobalMotion {
    unsigned char GmType[STD_VIDEO_AV1_NUM_REF_FRAMES];
    int gm_params[STD_VIDEO_AV1_NUM_REF_FRAMES][STD_VIDEO_AV1_GLOBAL_MOTION_PARAMS];
...
typedef struct StdVideoAV1FilmGrain {
    ...
    unsigned char point_y_value[STD_VIDEO_AV1_MAX_NUM_Y_POINTS];
    unsigned char point_y_scaling[STD_VIDEO_AV1_MAX_NUM_Y_POINTS];
    unsigned char num_cb_points;
    unsigned char point_cb_value[STD_VIDEO_AV1_MAX_NUM_CB_POINTS];
    unsigned char point_cb_scaling[STD_VIDEO_AV1_MAX_NUM_CB_POINTS];
    unsigned char num_cr_points;
    unsigned char point_cr_value[STD_VIDEO_AV1_MAX_NUM_CR_POINTS];
    unsigned char point_cr_scaling[STD_VIDEO_AV1_MAX_NUM_CR_POINTS];
    signed char ar_coeffs_y_plus_128[STD_VIDEO_AV1_MAX_NUM_POS_LUMA];
    signed char ar_coeffs_cb_plus_128[STD_VIDEO_AV1_MAX_NUM_POS_CHROMA];
    signed char ar_coeffs_cr_plus_128[STD_VIDEO_AV1_MAX_NUM_POS_CHROMA];
