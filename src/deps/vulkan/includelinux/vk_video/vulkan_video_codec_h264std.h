...
typedef struct StdVideoH264HrdParameters {
    ...
    unsigned int    bit_rate_value_minus1[STD_VIDEO_H264_CPB_CNT_LIST_SIZE];
    unsigned int    cpb_size_value_minus1[STD_VIDEO_H264_CPB_CNT_LIST_SIZE];
    unsigned char     cbr_flag[STD_VIDEO_H264_CPB_CNT_LIST_SIZE];
...
typedef struct StdVideoH264ScalingLists {
    ...
    unsigned char     ScalingList4x4[STD_VIDEO_H264_SCALING_LIST_4X4_NUM_LISTS][STD_VIDEO_H264_SCALING_LIST_4X4_NUM_ELEMENTS];
    unsigned char     ScalingList8x8[STD_VIDEO_H264_SCALING_LIST_8X8_NUM_LISTS][STD_VIDEO_H264_SCALING_LIST_8X8_NUM_ELEMENTS];
